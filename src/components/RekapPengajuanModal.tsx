...
export const RekapPengajuanModal: React.FC<RekapPengajuanModalProps> = ({
  ...
  const rekapData = useMemo(() => {
    ...
    // baru sisanya diurutkan abjad. Dideteksi otomatis dari field Jabatan pegawai
    // (bukan nama yang di-hardcode) agar tetap benar walau pejabatnya berganti di kemudian hari.
    const leadershipRank = (jabatan: string): number => {
    ...
    const activeEmployees = pegawaiList
      ...
      .sort((a, b) => {
        const rankDiff = leadershipRank(a.jabatan) - leadershipRank(b.jabatan);
